...
export interface CreateShopifyOrderActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyOrder?: { id?: string;additionalFees?: Scalars["JSON"];cancellation?: Scalars["JSON"];billingAddress?: Scalars["JSON"];browserIp?: string;buyerAcceptsMarketing?: boolean;cancelReason?: string;cancelledAt?: Date;cartToken?: string;checkoutToken?: string;clientDetails?: Scalars["JSON"];closedAt?: Date;currency?: string;customerLocale?: string;discountApplications?: Scalars["JSON"];discountCodes?: Scalars["JSON"];email?: string;estimatedTaxes?: boolean;financialStatus?: string;fulfillmentStatus?: string;landingSite?: string;name?: string;note?: string;noteAttributes?: Scalars["JSON"];orderStatusUrl?: string;paymentGatewayNames?: Scalars["JSON"];presentmentCurrency?: string;processedAt?: Date;processingMethod?: string;shippingAddress?: Scalars["JSON"];sourceName?: string;subtotalPrice?: string;subtotalPriceSet?: Scalars["JSON"];tags?: Scalars["JSON"];taxLines?: Scalars["JSON"];taxesIncluded?: boolean;test?: boolean;totalDiscounts?: string;totalDiscountsSet?: Scalars["JSON"];totalLineItemsPrice?: string;totalLineItemsPriceSet?: Scalars["JSON"];totalOutstanding?: string;totalPrice?: string;totalPriceSet?: Scalars["JSON"];totalTax?: string;totalTaxSet?: Scalars["JSON"];totalTipReceived?: string;totalWeight?: number;customer?: { _link: string | null };shopifyShop?: { _link: string | null };shop?: { _link: string | null };writeOrder?: boolean;autoWrite?: boolean; };
};
  /**
