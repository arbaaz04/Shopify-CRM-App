// All the generated types for the "speedafConfig" model preconditions, actions, params, etc
...
export interface CreateSpeedafConfigActionContext extends AmbientContext {
  ...
  */
  params: {
speedafConfig?: { apiEndpoint?: string;appCode?: string;customerCode?: string;lastAuthenticated?: Date;name?: string;platformSource?: string;secretKey?: string;shop?: { _link: string | null }; };
};
  /**
