// All the generated types for the "googleSheetConfig" model preconditions, actions, params, etc
...
export interface CreateGoogleSheetConfigActionContext extends AmbientContext {
  ...
  */
  params: {
googleSheetConfig?: { orderSheetName?: string;shop?: { _link: string | null };customerSheetName?: string;courierApiProvider?: string;spreadsheetId?: string;courierApiKey?: string; };
};
  /**
