// All the generated types for the "shopifyFulfillmentOrder" model preconditions, actions, params, etc
...
export interface CreateShopifyFulfillmentOrderActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyFulfillmentOrder?: { id?: string;shopifyCreatedAt?: Date;fulfillAt?: Date;fulfillBy?: Date;internationalDuties?: Scalars["JSON"];requestStatus?: string;status?: string;supportedActions?: Scalars["JSON"];shopifyUpdatedAt?: Date;order?: { _link: string | null };shop?: { _link: string | null }; };
};
  /**
