...
export interface CreateShopifyProductActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyProduct?: { id?: string;shopifyCreatedAt?: Date;handle?: string;productType?: string;publishedAt?: Date;status?: string;tags?: Scalars["JSON"];templateSuffix?: string;title?: string;shopifyUpdatedAt?: Date;vendor?: string;shop?: { _link: string | null };category?: Scalars["JSON"];compareAtPriceRange?: Scalars["JSON"];hasVariantsThatRequiresComponents?: boolean;productCategory?: Scalars["JSON"];body?: string; };
};
  /**
