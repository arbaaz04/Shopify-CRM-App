// All the generated types for the "deliveryCharges" model preconditions, actions, params, etc
...
export interface CreateDeliveryChargesActionContext extends AmbientContext {
  ...
  */
  params: {
deliveryCharges?: { currency?: string;lastUpdated?: Date;shop?: { _link: string | null };senditCharge?: number;speedafCharge?: number; };
};
  /**
