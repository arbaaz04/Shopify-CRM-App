...
export interface CreateShopifyProductVariantActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyProductVariant?: { id?: string;barcode?: string;compareAtPrice?: string;inventoryPolicy?: string;inventoryQuantity?: number;option1?: string;option2?: string;option3?: string;position?: number;price?: string;sku?: string;taxable?: boolean;title?: string;product?: { _link: string | null };shop?: { _link: string | null }; };
};
  /**
