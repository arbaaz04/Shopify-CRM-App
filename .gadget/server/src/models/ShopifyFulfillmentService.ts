// All the generated types for the "shopifyFulfillmentService" model preconditions, actions, params, etc
...
export interface CreateShopifyFulfillmentServiceActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyFulfillmentService?: { serviceName?: string;type?: string;adminGraphqlApiId?: string;callbackUrl?: string;format?: string;fulfillmentOrdersOptIn?: boolean;handle?: string;inventoryManagement?: boolean;name?: string;permitsSkuSharing?: boolean;requiresShippingMethod?: boolean;trackingSupport?: boolean;shop?: { _link: string | null }; };
};
  /**
