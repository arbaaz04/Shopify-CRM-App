// All the generated types for the "shopifyCustomer" model preconditions, actions, params, etc
...
export interface CreateShopifyCustomerActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyCustomer?: { id?: string;statistics?: Scalars["JSON"];locale?: string;acceptsMarketing?: boolean;acceptsMarketingUpdatedAt?: Date;shopifyCreatedAt?: Date;currency?: string;email?: string;emailMarketingConsent?: Scalars["JSON"];firstName?: string;lastName?: string;marketingOptInLevel?: string;multipassIdentifier?: string;note?: string;phone?: string;smsMarketingConsent?: Scalars["JSON"];shopifyState?: string;tags?: Scalars["JSON"];taxExempt?: boolean;taxExemptions?: string[];shopifyUpdatedAt?: Date;verifiedEmail?: boolean;lastOrder?: { _link: string | null };shop?: { _link: string | null }; };
};
  /**
