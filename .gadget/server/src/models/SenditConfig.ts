// All the generated types for the "senditConfig" model preconditions, actions, params, etc
...
export interface CreateSenditConfigActionContext extends AmbientContext {
  ...
  */
  params: {
senditConfig?: { accountType?: string;lastAuthenticated?: Date;name?: string;publicKey?: string;secretKey?: string;shop?: { _link: string | null };token?: string; };
};
  /**
