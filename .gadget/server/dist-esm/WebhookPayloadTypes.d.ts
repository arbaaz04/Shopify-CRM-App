...
*/
export type ShopifyWebhookTrigger = ShopifyAppUninstalledTrigger | ShopifyCustomersDataRequestTrigger | ShopifyCustomersRedactTrigger | ShopifyFulfillmentOrdersCancellationRequestAcceptedTrigger | ShopifyFulfillmentOrdersCancellationRequestRejectedTrigger | ShopifyFulfillmentOrdersCancellationRequestSubmittedTrigger | ShopifyFulfillmentOrdersCancelledTrigger | ShopifyFulfillmentOrdersFulfillmentRequestAcceptedTrigger | ShopifyFulfillmentOrdersFulfillmentRequestRejectedTrigger | ShopifyFulfillmentOrdersFulfillmentRequestSubmittedTrigger | ShopifyCustomersCreateTrigger | ShopifyCustomersDeleteTrigger | ShopifyFulfillmentOrdersFulfillmentServiceFailedToCompleteTrigger | ShopifyFulfillmentOrdersHoldReleasedTrigger | ShopifyCustomersUpdateTrigger | ShopifyFulfillmentOrdersLineItemsPreparedForLocalDeliveryTrigger | ShopifyFulfillmentOrdersLineItemsPreparedForPickupTrigger | ShopifyFulfillmentOrdersMergedTrigger | ShopifyFulfillmentOrdersMovedTrigger | ShopifyFulfillmentOrdersOrderRoutingCompleteTrigger | ShopifyFulfillmentOrdersPlacedOnHoldTrigger | ShopifyFulfillmentOrdersRescheduledTrigger | ShopifyFulfillmentOrdersScheduledFulfillmentOrderReadyTrigger | ShopifyFulfillmentOrdersSplitTrigger | ShopifyOrdersCreateTrigger | ShopifyOrdersDeleteTrigger | ShopifyOrdersRiskAssessmentChangedTrigger | ShopifyOrdersUpdatedTrigger | ShopifyProductsCreateTrigger | ShopifyProductsDeleteTrigger | ShopifyProductsUpdateTrigger | ShopifyShopRedactTrigger | ShopifyShopUpdateTrigger | ShopifyFulfillmentsCreateTrigger | ShopifyFulfillmentsUpdateTrigger;
/**
