...
import {
  ...
  SenditTracking,
  AvailableSenditTrackingSelection,
  SenditTrackingSort,
  SenditTrackingFilter
} from "../types.js";
...
*/
export type SelectedSenditTrackingOrDefault<Options extends Selectable<AvailableSenditTrackingSelection>> = DeepFilterNever<
    Select<
      SenditTracking,
      DefaultSelection<
        AvailableSenditTrackingSelection,
        Options,
        typeof DefaultSenditTrackingSelection
      >
    >
  >;
 ...
 * ```
 */
export type SenditTrackingRecord<Selection extends AvailableSenditTrackingSelection | undefined = typeof DefaultSenditTrackingSelection> = DeepFilterNever<
  GadgetRecord<
    SelectedSenditTrackingOrDefault<{
      select: Selection;
    }>
  >
>;

export const DefaultSenditTrackingSelection = {
     __typename: true,
     id: true,
     createdAt: true,
     data: true,
...
const modelApiIdentifier = "senditTracking" as const;
const pluralModelApiIdentifier = "senditTrackings" as const;
...
/**
 * A manager for the senditTracking model with all the available operations for reading and writing to it.*/
export const SenditTrackingManager = buildModelManager(
  modelApiIdentifier,
