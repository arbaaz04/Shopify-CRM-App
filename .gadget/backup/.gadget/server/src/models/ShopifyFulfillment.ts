...
export interface CreateShopifyFulfillmentActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyFulfillment?: { id?: string;name?: string;order?: { _link: string | null };originAddress?: Scalars["JSON"];receipt?: Scalars["JSON"];service?: string;shipmentStatus?: string;shopifyCreatedAt?: Date;status?: string;shopifyUpdatedAt?: Date;deliveredAt?: Date;trackingCompany?: string;trackingNumbers?: Scalars["JSON"];trackingUrls?: Scalars["JSON"];displayStatus?: string;estimatedDeliveryAt?: Date;inTransitAt?: Date;requiresShipping?: boolean;totalQuantity?: number;trackingInfo?: Scalars["JSON"];shop?: { _link: string | null }; };
};
  /**
