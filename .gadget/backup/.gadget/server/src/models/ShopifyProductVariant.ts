// All the generated types for the "shopifyProductVariant" model preconditions, actions, params, etc
...
export interface CreateShopifyProductVariantActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyProductVariant?: { id?: string;barcode?: string;compareAtPrice?: string;product?: { _link: string | null };inventoryPolicy?: string;inventoryQuantity?: number;option1?: string;option2?: string;selectedOptions?: Scalars["JSON"];option3?: string;position?: number;price?: string;shopifyCreatedAt?: Date;sku?: string;taxCode?: string;shopifyUpdatedAt?: Date;presentmentPrices?: Scalars["JSON"];taxable?: boolean;title?: string;shop?: { _link: string | null }; };
};
  /**
