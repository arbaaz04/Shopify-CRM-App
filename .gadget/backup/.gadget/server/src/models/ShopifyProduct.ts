...
export interface CreateShopifyProductActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyProduct?: { id?: string;category?: Scalars["JSON"];hasVariantsThatRequiresComponents?: boolean;body?: string;shopifyCreatedAt?: Date;handle?: string;productType?: string;publishedAt?: Date;status?: string;tags?: Scalars["JSON"];templateSuffix?: string;shopifyUpdatedAt?: Date;compareAtPriceRange?: Scalars["JSON"];productCategory?: Scalars["JSON"];title?: string;vendor?: string;shop?: { _link: string | null }; };
};
  /**
