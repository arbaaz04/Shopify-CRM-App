 ...
 * Is a GadgetRecord of the model's type.
 **/
export type FindFirstSpeedafConfigResult<Options extends FindFirstSpeedafConfigOptions> = SelectedSpeedafConfigOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedSpeedafConfigOrDefault<Options>>;
/**
...
export type SpeedafConfigManager = {
  ...
  findFirst: {
      ...
      **/
      <Options extends FindFirstSpeedafConfigOptions>(
        id: string,
      
        options?: LimitToKnownKeys<Options, FindFirstSpeedafConfigOptions>
      ): Promise<FindFirstSpeedafConfigResult<Options>>;
      type: 'action';
