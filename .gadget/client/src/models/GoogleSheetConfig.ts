...
import {
  ...
  GoogleSheetConfig,
  AvailableGoogleSheetConfigSelection,
  GoogleSheetConfigSort,
  GoogleSheetConfigFilter,
  CreateGoogleSheetConfigInput,
  UpdateGoogleSheetConfigInput,
  Scalars,
  UpsertGoogleSheetConfigInput
} from "../types.js";
...
*/
export type SelectedGoogleSheetConfigOrDefault<Options extends Selectable<AvailableGoogleSheetConfigSelection>> = DeepFilterNever<
    Select<
      GoogleSheetConfig,
      DefaultSelection<
        AvailableGoogleSheetConfigSelection,
        Options,
        typeof DefaultGoogleSheetConfigSelection
      >
    >
  >;
 ...
 * ```
 */
export type GoogleSheetConfigRecord<Selection extends AvailableGoogleSheetConfigSelection | undefined = typeof DefaultGoogleSheetConfigSelection> = DeepFilterNever<
  GadgetRecord<
    SelectedGoogleSheetConfigOrDefault<{
      select: Selection;
    }>
  >
>;

export const DefaultGoogleSheetConfigSelection = {
     __typename: true,
     id: true,
     courierApiKey: true,
...
const modelApiIdentifier = "googleSheetConfig" as const;
const pluralModelApiIdentifier = "googleSheetConfigs" as const;
 ...
 **/
export type CreateGoogleSheetConfigResult<Options extends CreateGoogleSheetConfigOptions> = SelectedGoogleSheetConfigOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedGoogleSheetConfigOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateGoogleSheetConfigResult<Options extends UpdateGoogleSheetConfigOptions> = SelectedGoogleSheetConfigOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedGoogleSheetConfigOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertGoogleSheetConfigVariables = Omit<
     UpsertGoogleSheetConfigInput,
     "on"
   > & {
     on?: ((Scalars['String'] | null))[];
 ...
 *
 **/
export type UpsertGoogleSheetConfigResult<Options extends UpsertGoogleSheetConfigOptions> = SelectedGoogleSheetConfigOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedGoogleSheetConfigOrDefault<Options>>;
...
export type GoogleSheetConfigManager = {
  ...
  create: {
      ...
      * * const googleSheetConfigRecord = await api.googleSheetConfig.create({
        ...
        * });
      **/
      <Options extends CreateGoogleSheetConfigOptions>(
      
        variables: CreateGoogleSheetConfigVariables,
        options?: LimitToKnownKeys<Options, CreateGoogleSheetConfigOptions>
      ): Promise<CreateGoogleSheetConfigResult<Options>>;
      /**
       * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      ...
      **/
      <Options extends CreateGoogleSheetConfigOptions>(
        ...
        variables: FullyQualifiedCreateGoogleSheetConfigVariables,
        options?: LimitToKnownKeys<Options, CreateGoogleSheetConfigOptions>
      ): Promise<CreateGoogleSheetConfigResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedCreateGoogleSheetConfigVariables | CreateGoogleSheetConfigVariables)
             ) | undefined);
  ...
  bulkCreate: {
      /**
        ...
        */
       <Options extends CreateGoogleSheetConfigOptions>(
          inputs: (FullyQualifiedCreateGoogleSheetConfigVariables | CreateGoogleSheetConfigVariables)[],
          options?: LimitToKnownKeys<Options, CreateGoogleSheetConfigOptions>
       ): Promise<CreateGoogleSheetConfigResult<Options>[]>
      type: 'action';
  ...
  update: {
      ...
      * * const googleSheetConfigRecord = await api.googleSheetConfig.update("1", {
        ...
        * });
      **/
      <Options extends UpdateGoogleSheetConfigOptions>(
        id: string,
        variables: UpdateGoogleSheetConfigVariables,
        options?: LimitToKnownKeys<Options, UpdateGoogleSheetConfigOptions>
      ): Promise<UpdateGoogleSheetConfigResult<Options>>;
      /**
       * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpdateGoogleSheetConfigOptions>(
        id: string,
        variables: FullyQualifiedUpdateGoogleSheetConfigVariables,
        options?: LimitToKnownKeys<Options, UpdateGoogleSheetConfigOptions>
      ): Promise<UpdateGoogleSheetConfigResult<Options>>;
      type: 'action';
  ...
  bulkUpdate: {
      /**
        ...
        */
       <Options extends UpdateGoogleSheetConfigOptions>(
          inputs: (FullyQualifiedUpdateGoogleSheetConfigVariables | UpdateGoogleSheetConfigVariables & { id: string })[],
          options?: LimitToKnownKeys<Options, UpdateGoogleSheetConfigOptions>
       ): Promise<UpdateGoogleSheetConfigResult<Options>[]>
      type: 'action';
      ...
      variablesType: (FullyQualifiedUpdateGoogleSheetConfigVariables | UpdateGoogleSheetConfigVariables & { id: string })[];
      paramOnlyVariables: [];
      selectionType: AvailableGoogleSheetConfigSelection;
      schemaType: Query["googleSheetConfig"];
      defaultSelection: typeof DefaultGoogleSheetConfigSelection;
  ...
  delete: {
      ...
      **/
      <Options extends DeleteGoogleSheetConfigOptions>(
        id: string,
      
        options?: LimitToKnownKeys<Options, DeleteGoogleSheetConfigOptions>
      ): Promise<DeleteGoogleSheetConfigResult<Options>>;
      type: 'action';
  ...
  upsert: {
      ...
      * * const result = await api.googleSheetConfig.upsert({
        ...
        * });
      **/
      <Options extends UpsertGoogleSheetConfigOptions>(
      
        variables: UpsertGoogleSheetConfigVariables,
        options?: LimitToKnownKeys<Options, UpsertGoogleSheetConfigOptions>
      ): Promise<UpsertGoogleSheetConfigResult<Options>>;
      /**
       * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpsertGoogleSheetConfigOptions>(
        ...
        variables: FullyQualifiedUpsertGoogleSheetConfigVariables,
        options?: LimitToKnownKeys<Options, UpsertGoogleSheetConfigOptions>
      ): Promise<UpsertGoogleSheetConfigResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedUpsertGoogleSheetConfigVariables | UpsertGoogleSheetConfigVariables)
             ) | undefined);
      hasAmbiguousIdentifier: false;
  ...
  bulkUpsert: {
      /**
        ...
        */
       <Options extends UpsertGoogleSheetConfigOptions>(
          inputs: (FullyQualifiedUpsertGoogleSheetConfigVariables | UpsertGoogleSheetConfigVariables)[],
          options?: LimitToKnownKeys<Options, UpsertGoogleSheetConfigOptions>
       ): Promise<any[]>
      type: 'action';
...
/**
 * A manager for the googleSheetConfig model with all the available operations for reading and writing to it.*/
export const GoogleSheetConfigManager = buildModelManager(
  modelApiIdentifier,
