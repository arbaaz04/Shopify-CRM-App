...
import {
  ...
  DeliveryCharges,
  AvailableDeliveryChargesSelection,
  DeliveryChargesSort,
  DeliveryChargesFilter,
  CreateDeliveryChargesInput,
  UpdateDeliveryChargesInput,
  Scalars,
  UpsertDeliveryChargesInput
} from "../types.js";
...
*/
export type SelectedDeliveryChargesOrDefault<Options extends Selectable<AvailableDeliveryChargesSelection>> = DeepFilterNever<
    Select<
      DeliveryCharges,
      DefaultSelection<
        AvailableDeliveryChargesSelection,
        Options,
        typeof DefaultDeliveryChargesSelection
      >
    >
  >;
 ...
 * ```
 */
export type DeliveryChargesRecord<Selection extends AvailableDeliveryChargesSelection | undefined = typeof DefaultDeliveryChargesSelection> = DeepFilterNever<
  GadgetRecord<
    SelectedDeliveryChargesOrDefault<{
      select: Selection;
    }>
  >
>;

export const DefaultDeliveryChargesSelection = {
     __typename: true,
     id: true,
     createdAt: true,
     currency: true,
...
const modelApiIdentifier = "deliveryCharges" as const;
const pluralModelApiIdentifier = "deliveryChargess" as const;
 ...
 **/
export type CreateDeliveryChargesResult<Options extends CreateDeliveryChargesOptions> = SelectedDeliveryChargesOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedDeliveryChargesOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateDeliveryChargesResult<Options extends UpdateDeliveryChargesOptions> = SelectedDeliveryChargesOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedDeliveryChargesOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertDeliveryChargesVariables = Omit<
     UpsertDeliveryChargesInput,
     "on"
   > & {
     on?: ((Scalars['String'] | null))[];
 ...
 *
 **/
export type UpsertDeliveryChargesResult<Options extends UpsertDeliveryChargesOptions> = SelectedDeliveryChargesOrDefault<Options> extends void ?
      void :
      GadgetRecord<SelectedDeliveryChargesOrDefault<Options>>;
...
export type DeliveryChargesManager = {
  ...
  create: {
      ...
      * * const deliveryChargesRecord = await api.deliveryCharges.create({
        ...
        * });
      **/
      <Options extends CreateDeliveryChargesOptions>(
      
        variables: CreateDeliveryChargesVariables,
        options?: LimitToKnownKeys<Options, CreateDeliveryChargesOptions>
      ): Promise<CreateDeliveryChargesResult<Options>>;
      /**
       * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      ...
      **/
      <Options extends CreateDeliveryChargesOptions>(
        ...
        variables: FullyQualifiedCreateDeliveryChargesVariables,
        options?: LimitToKnownKeys<Options, CreateDeliveryChargesOptions>
      ): Promise<CreateDeliveryChargesResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedCreateDeliveryChargesVariables | CreateDeliveryChargesVariables)
             ) | undefined);
  ...
  bulkCreate: {
      /**
        ...
        */
       <Options extends CreateDeliveryChargesOptions>(
          inputs: (FullyQualifiedCreateDeliveryChargesVariables | CreateDeliveryChargesVariables)[],
          options?: LimitToKnownKeys<Options, CreateDeliveryChargesOptions>
       ): Promise<CreateDeliveryChargesResult<Options>[]>
      type: 'action';
  ...
  update: {
      ...
      * * const deliveryChargesRecord = await api.deliveryCharges.update("1", {
        ...
        * });
      **/
      <Options extends UpdateDeliveryChargesOptions>(
        id: string,
        variables: UpdateDeliveryChargesVariables,
        options?: LimitToKnownKeys<Options, UpdateDeliveryChargesOptions>
      ): Promise<UpdateDeliveryChargesResult<Options>>;
      /**
       * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpdateDeliveryChargesOptions>(
        id: string,
        variables: FullyQualifiedUpdateDeliveryChargesVariables,
        options?: LimitToKnownKeys<Options, UpdateDeliveryChargesOptions>
      ): Promise<UpdateDeliveryChargesResult<Options>>;
      type: 'action';
  ...
  bulkUpdate: {
      /**
        ...
        */
       <Options extends UpdateDeliveryChargesOptions>(
          inputs: (FullyQualifiedUpdateDeliveryChargesVariables | UpdateDeliveryChargesVariables & { id: string })[],
          options?: LimitToKnownKeys<Options, UpdateDeliveryChargesOptions>
       ): Promise<UpdateDeliveryChargesResult<Options>[]>
      type: 'action';
      ...
      variablesType: (FullyQualifiedUpdateDeliveryChargesVariables | UpdateDeliveryChargesVariables & { id: string })[];
      paramOnlyVariables: [];
      selectionType: AvailableDeliveryChargesSelection;
      schemaType: Query["deliveryCharges"];
      defaultSelection: typeof DefaultDeliveryChargesSelection;
  ...
  delete: {
      ...
      **/
      <Options extends DeleteDeliveryChargesOptions>(
        id: string,
      
        options?: LimitToKnownKeys<Options, DeleteDeliveryChargesOptions>
      ): Promise<DeleteDeliveryChargesResult<Options>>;
      type: 'action';
  ...
  upsert: {
      ...
      * * const result = await api.deliveryCharges.upsert({
        ...
        * });
      **/
      <Options extends UpsertDeliveryChargesOptions>(
      
        variables: UpsertDeliveryChargesVariables,
        options?: LimitToKnownKeys<Options, UpsertDeliveryChargesOptions>
      ): Promise<UpsertDeliveryChargesResult<Options>>;
      /**
       * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
      *
      * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
      ...
      **/
      <Options extends UpsertDeliveryChargesOptions>(
        ...
        variables: FullyQualifiedUpsertDeliveryChargesVariables,
        options?: LimitToKnownKeys<Options, UpsertDeliveryChargesOptions>
      ): Promise<UpsertDeliveryChargesResult<Options>>;
      type: 'action';
      ...
      variablesType: ((
               ...
               & (FullyQualifiedUpsertDeliveryChargesVariables | UpsertDeliveryChargesVariables)
             ) | undefined);
      hasAmbiguousIdentifier: false;
  ...
  bulkUpsert: {
      /**
        ...
        */
       <Options extends UpsertDeliveryChargesOptions>(
          inputs: (FullyQualifiedUpsertDeliveryChargesVariables | UpsertDeliveryChargesVariables)[],
          options?: LimitToKnownKeys<Options, UpsertDeliveryChargesOptions>
       ): Promise<any[]>
      type: 'action';
...
/**
 * A manager for the deliveryCharges model with all the available operations for reading and writing to it.*/
export const DeliveryChargesManager = buildModelManager(
  modelApiIdentifier,
