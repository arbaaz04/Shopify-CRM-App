...
Note: When declaring authentication modes, you can only declare authentication modes at the top level, or under the `authenticationMode` key. If you declare them at the top level and under the `authenticationMode` key at the same time, an error will be thrown.
  ...
  export class BambeCrmAppClient implements AnyClient {
    ...
    debugOrderShipping = buildGlobalAction(this, {
                         type: 'globalAction',
    ...
    getDeliveryCharges = buildGlobalAction(this, {
                         type: 'globalAction',
    ...
    getShippingCost = buildGlobalAction(this, {
                         type: 'globalAction',
    ...
    updateDeliveryCharge = buildGlobalAction(this, {
                         type: 'globalAction',
