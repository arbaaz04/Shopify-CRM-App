...
import { Query, Select, DeepFilterNever, IDsList, PromiseOrLiveIterator, BlacklistedPhone, AvailableBlacklistedPhoneSelection, BlacklistedPhoneSort, BlacklistedPhoneFilter, CreateBlacklistedPhoneInput } from "../types.js";
/**
...
*/
export type SelectedBlacklistedPhoneOrDefault<Options extends Selectable<AvailableBlacklistedPhoneSelection>> = DeepFilterNever<Select<BlacklistedPhone, DefaultSelection<AvailableBlacklistedPhoneSelection, Options, typeof DefaultBlacklistedPhoneSelection>>>;
/**
 ...
 * ```
 */
export type BlacklistedPhoneRecord<Selection extends AvailableBlacklistedPhoneSelection | undefined = typeof DefaultBlacklistedPhoneSelection> = DeepFilterNever<GadgetRecord<SelectedBlacklistedPhoneOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultBlacklistedPhoneSelection: {
...
declare const modelApiIdentifier: "blacklistedPhone";
declare const pluralModelApiIdentifier: "blacklistedPhones";
 ...
 **/
export type CreateBlacklistedPhoneResult<Options extends CreateBlacklistedPhoneOptions> = SelectedBlacklistedPhoneOrDefault<Options> extends void ? void : GadgetRecord<SelectedBlacklistedPhoneOrDefault<Options>>;
/**
...
export type BlacklistedPhoneManager = {
    ...
    create: {
        ...
        * * const blacklistedPhoneRecord = await api.blacklistedPhone.create({
          ...
          * });
        **/
        <Options extends CreateBlacklistedPhoneOptions>(variables: CreateBlacklistedPhoneVariables, options?: LimitToKnownKeys<Options, CreateBlacklistedPhoneOptions>): Promise<CreateBlacklistedPhoneResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const blacklistedPhoneRecord = await api.blacklistedPhone.create({
          ...
          * });
        **/
        <Options extends CreateBlacklistedPhoneOptions>(variables: FullyQualifiedCreateBlacklistedPhoneVariables, options?: LimitToKnownKeys<Options, CreateBlacklistedPhoneOptions>): Promise<CreateBlacklistedPhoneResult<Options>>;
        type: 'action';
        ...
        variables: {
            blacklistedPhone: {
                required: false;
                type: 'CreateBlacklistedPhoneInput';
            };
        };
        variablesType: (((FullyQualifiedCreateBlacklistedPhoneVariables | CreateBlacklistedPhoneVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateBlacklistedPhoneOptions>(inputs: (FullyQualifiedCreateBlacklistedPhoneVariables | CreateBlacklistedPhoneVariables)[], options?: LimitToKnownKeys<Options, CreateBlacklistedPhoneOptions>): Promise<CreateBlacklistedPhoneResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateBlacklistedPhonesInput!]';
            };
        };
    ...
    delete: {
        ...
        **/
        <Options extends DeleteBlacklistedPhoneOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteBlacklistedPhoneOptions>): Promise<DeleteBlacklistedPhoneResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        /**
          ...
          */
        <Options extends DeleteBlacklistedPhoneOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteBlacklistedPhoneOptions>): Promise<DeleteBlacklistedPhoneResult<Options>[]>;
        type: 'action';
...
/**
 * A manager for the blacklistedPhone model with all the available operations for reading and writing to it.*/
export declare const BlacklistedPhoneManager: {
