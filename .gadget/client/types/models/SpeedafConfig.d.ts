...
import { Query, Select, DeepFilterNever, IDsList, PromiseOrLiveIterator, SpeedafConfig, AvailableSpeedafConfigSelection, SpeedafConfigSort, SpeedafConfigFilter, CreateSpeedafConfigInput, UpdateSpeedafConfigInput, Scalars, UpsertSpeedafConfigInput } from "../types.js";
/**
...
*/
export type SelectedSpeedafConfigOrDefault<Options extends Selectable<AvailableSpeedafConfigSelection>> = DeepFilterNever<Select<SpeedafConfig, DefaultSelection<AvailableSpeedafConfigSelection, Options, typeof DefaultSpeedafConfigSelection>>>;
/**
 ...
 * ```
 */
export type SpeedafConfigRecord<Selection extends AvailableSpeedafConfigSelection | undefined = typeof DefaultSpeedafConfigSelection> = DeepFilterNever<GadgetRecord<SelectedSpeedafConfigOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultSpeedafConfigSelection: {
...
declare const modelApiIdentifier: "speedafConfig";
declare const pluralModelApiIdentifier: "speedafConfigs";
 ...
 **/
export type CreateSpeedafConfigResult<Options extends CreateSpeedafConfigOptions> = SelectedSpeedafConfigOrDefault<Options> extends void ? void : GadgetRecord<SelectedSpeedafConfigOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateSpeedafConfigResult<Options extends UpdateSpeedafConfigOptions> = SelectedSpeedafConfigOrDefault<Options> extends void ? void : GadgetRecord<SelectedSpeedafConfigOrDefault<Options>>;
/**
...
/**
 * The return value from executing findFirst on speedafConfig
 * Is a GadgetRecord of the model's type.
 **/
export type FindFirstSpeedafConfigResult<Options extends FindFirstSpeedafConfigOptions> = SelectedSpeedafConfigOrDefault<Options> extends void ? void : GadgetRecord<SelectedSpeedafConfigOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertSpeedafConfigVariables = Omit<UpsertSpeedafConfigInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
 ...
 *
 **/
export type UpsertSpeedafConfigResult<Options extends UpsertSpeedafConfigOptions> = SelectedSpeedafConfigOrDefault<Options> extends void ? void : GadgetRecord<SelectedSpeedafConfigOrDefault<Options>>;
/**
...
export type SpeedafConfigManager = {
    ...
    create: {
        ...
        * * const speedafConfigRecord = await api.speedafConfig.create({
          ...
          *   secretKey: "example value for secretKey",
          *   shop: {
          *     _link: "1",
          *   },
          * });
        **/
        <Options extends CreateSpeedafConfigOptions>(variables: CreateSpeedafConfigVariables, options?: LimitToKnownKeys<Options, CreateSpeedafConfigOptions>): Promise<CreateSpeedafConfigResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const speedafConfigRecord = await api.speedafConfig.create({
          ...
          * });
        **/
        <Options extends CreateSpeedafConfigOptions>(variables: FullyQualifiedCreateSpeedafConfigVariables, options?: LimitToKnownKeys<Options, CreateSpeedafConfigOptions>): Promise<CreateSpeedafConfigResult<Options>>;
        type: 'action';
        ...
        variables: {
            speedafConfig: {
                required: false;
                type: 'CreateSpeedafConfigInput';
            };
        };
        variablesType: (((FullyQualifiedCreateSpeedafConfigVariables | CreateSpeedafConfigVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateSpeedafConfigOptions>(inputs: (FullyQualifiedCreateSpeedafConfigVariables | CreateSpeedafConfigVariables)[], options?: LimitToKnownKeys<Options, CreateSpeedafConfigOptions>): Promise<CreateSpeedafConfigResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateSpeedafConfigsInput!]';
            };
        };
    ...
    update: {
        ...
        * * const speedafConfigRecord = await api.speedafConfig.update("1", {
          ...
          * });
        **/
        <Options extends UpdateSpeedafConfigOptions>(id: string, variables: UpdateSpeedafConfigVariables, options?: LimitToKnownKeys<Options, UpdateSpeedafConfigOptions>): Promise<UpdateSpeedafConfigResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const speedafConfigRecord = await api.speedafConfig.update("1", {
          ...
          * });
        **/
        <Options extends UpdateSpeedafConfigOptions>(id: string, variables: FullyQualifiedUpdateSpeedafConfigVariables, options?: LimitToKnownKeys<Options, UpdateSpeedafConfigOptions>): Promise<UpdateSpeedafConfigResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateSpeedafConfigOptions>(inputs: (FullyQualifiedUpdateSpeedafConfigVariables | UpdateSpeedafConfigVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateSpeedafConfigOptions>): Promise<UpdateSpeedafConfigResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateSpeedafConfigsInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateSpeedafConfigVariables | UpdateSpeedafConfigVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableSpeedafConfigSelection;
    ...
    delete: {
        ...
        **/
        <Options extends DeleteSpeedafConfigOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteSpeedafConfigOptions>): Promise<DeleteSpeedafConfigResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        /**
          ...
          */
        <Options extends DeleteSpeedafConfigOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteSpeedafConfigOptions>): Promise<DeleteSpeedafConfigResult<Options>[]>;
        type: 'action';
    ...
    findFirst: {
        ...
        *
        * @example
        * * const speedafConfigRecord = await api.speedafConfig.findFirst("1");
        **/
        <Options extends FindFirstSpeedafConfigOptions>(id: string, options?: LimitToKnownKeys<Options, FindFirstSpeedafConfigOptions>): Promise<FindFirstSpeedafConfigResult<Options>>;
        type: 'action';
    ...
    bulkFindFirst: {
        /**
          ...
          */
        <Options extends FindFirstSpeedafConfigOptions>(ids: string[], options?: LimitToKnownKeys<Options, FindFirstSpeedafConfigOptions>): Promise<FindFirstSpeedafConfigResult<Options>[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.speedafConfig.upsert({
          ...
          * });
        **/
        <Options extends UpsertSpeedafConfigOptions>(variables: UpsertSpeedafConfigVariables, options?: LimitToKnownKeys<Options, UpsertSpeedafConfigOptions>): Promise<UpsertSpeedafConfigResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.speedafConfig.upsert({
          ...
          * });
        **/
        <Options extends UpsertSpeedafConfigOptions>(variables: FullyQualifiedUpsertSpeedafConfigVariables, options?: LimitToKnownKeys<Options, UpsertSpeedafConfigOptions>): Promise<UpsertSpeedafConfigResult<Options>>;
        type: 'action';
        ...
        variables: {
            ...
            speedafConfig: {
                required: false;
                type: 'UpsertSpeedafConfigInput';
            };
        };
        variablesType: (((FullyQualifiedUpsertSpeedafConfigVariables | UpsertSpeedafConfigVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateSpeedafConfigResult': {
                hasReturnType: false;
            };
            '... on UpdateSpeedafConfigResult': {
                hasReturnType: false;
            };
        };
        acceptsModelInput: true;
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertSpeedafConfigOptions>(inputs: (FullyQualifiedUpsertSpeedafConfigVariables | UpsertSpeedafConfigVariables)[], options?: LimitToKnownKeys<Options, UpsertSpeedafConfigOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpsertSpeedafConfigsInput!]';
            };
        };
...
/**
 * A manager for the speedafConfig model with all the available operations for reading and writing to it.*/
export declare const SpeedafConfigManager: {
