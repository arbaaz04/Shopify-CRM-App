...
import { Query, Select, DeepFilterNever, IDsList, PromiseOrLiveIterator, SenditConfig, AvailableSenditConfigSelection, SenditConfigSort, SenditConfigFilter, CreateSenditConfigInput, UpdateSenditConfigInput, Scalars, UpsertSenditConfigInput } from "../types.js";
/**
...
*/
export type SelectedSenditConfigOrDefault<Options extends Selectable<AvailableSenditConfigSelection>> = DeepFilterNever<Select<SenditConfig, DefaultSelection<AvailableSenditConfigSelection, Options, typeof DefaultSenditConfigSelection>>>;
/**
 ...
 * ```
 */
export type SenditConfigRecord<Selection extends AvailableSenditConfigSelection | undefined = typeof DefaultSenditConfigSelection> = DeepFilterNever<GadgetRecord<SelectedSenditConfigOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultSenditConfigSelection: {
...
declare const modelApiIdentifier: "senditConfig";
declare const pluralModelApiIdentifier: "senditConfigs";
 ...
 **/
export type CreateSenditConfigResult<Options extends CreateSenditConfigOptions> = SelectedSenditConfigOrDefault<Options> extends void ? void : GadgetRecord<SelectedSenditConfigOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateSenditConfigResult<Options extends UpdateSenditConfigOptions> = SelectedSenditConfigOrDefault<Options> extends void ? void : GadgetRecord<SelectedSenditConfigOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertSenditConfigVariables = Omit<UpsertSenditConfigInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
 ...
 *
 **/
export type UpsertSenditConfigResult<Options extends UpsertSenditConfigOptions> = SelectedSenditConfigOrDefault<Options> extends void ? void : GadgetRecord<SelectedSenditConfigOrDefault<Options>>;
/**
...
export type SenditConfigManager = {
    ...
    create: {
        ...
        * * const senditConfigRecord = await api.senditConfig.create({
          ...
          * });
        **/
        <Options extends CreateSenditConfigOptions>(variables: CreateSenditConfigVariables, options?: LimitToKnownKeys<Options, CreateSenditConfigOptions>): Promise<CreateSenditConfigResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const senditConfigRecord = await api.senditConfig.create({
          ...
          * });
        **/
        <Options extends CreateSenditConfigOptions>(variables: FullyQualifiedCreateSenditConfigVariables, options?: LimitToKnownKeys<Options, CreateSenditConfigOptions>): Promise<CreateSenditConfigResult<Options>>;
        type: 'action';
        ...
        variables: {
            senditConfig: {
                required: false;
                type: 'CreateSenditConfigInput';
            };
        };
        variablesType: (((FullyQualifiedCreateSenditConfigVariables | CreateSenditConfigVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateSenditConfigOptions>(inputs: (FullyQualifiedCreateSenditConfigVariables | CreateSenditConfigVariables)[], options?: LimitToKnownKeys<Options, CreateSenditConfigOptions>): Promise<CreateSenditConfigResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateSenditConfigsInput!]';
            };
        };
    ...
    update: {
        ...
        * * const senditConfigRecord = await api.senditConfig.update("1", {
          ...
          * });
        **/
        <Options extends UpdateSenditConfigOptions>(id: string, variables: UpdateSenditConfigVariables, options?: LimitToKnownKeys<Options, UpdateSenditConfigOptions>): Promise<UpdateSenditConfigResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const senditConfigRecord = await api.senditConfig.update("1", {
          ...
          * });
        **/
        <Options extends UpdateSenditConfigOptions>(id: string, variables: FullyQualifiedUpdateSenditConfigVariables, options?: LimitToKnownKeys<Options, UpdateSenditConfigOptions>): Promise<UpdateSenditConfigResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateSenditConfigOptions>(inputs: (FullyQualifiedUpdateSenditConfigVariables | UpdateSenditConfigVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateSenditConfigOptions>): Promise<UpdateSenditConfigResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateSenditConfigsInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateSenditConfigVariables | UpdateSenditConfigVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableSenditConfigSelection;
    ...
    delete: {
        ...
        **/
        <Options extends DeleteSenditConfigOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteSenditConfigOptions>): Promise<DeleteSenditConfigResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        /**
          ...
          */
        <Options extends DeleteSenditConfigOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteSenditConfigOptions>): Promise<DeleteSenditConfigResult<Options>[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.senditConfig.upsert({
          ...
          * });
        **/
        <Options extends UpsertSenditConfigOptions>(variables: UpsertSenditConfigVariables, options?: LimitToKnownKeys<Options, UpsertSenditConfigOptions>): Promise<UpsertSenditConfigResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.senditConfig.upsert({
          ...
          * });
        **/
        <Options extends UpsertSenditConfigOptions>(variables: FullyQualifiedUpsertSenditConfigVariables, options?: LimitToKnownKeys<Options, UpsertSenditConfigOptions>): Promise<UpsertSenditConfigResult<Options>>;
        type: 'action';
        ...
        variables: {
            ...
            senditConfig: {
                required: false;
                type: 'UpsertSenditConfigInput';
            };
        };
        variablesType: (((FullyQualifiedUpsertSenditConfigVariables | UpsertSenditConfigVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateSenditConfigResult': {
                hasReturnType: false;
            };
            '... on UpdateSenditConfigResult': {
                hasReturnType: false;
            };
        };
        acceptsModelInput: true;
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertSenditConfigOptions>(inputs: (FullyQualifiedUpsertSenditConfigVariables | UpsertSenditConfigVariables)[], options?: LimitToKnownKeys<Options, UpsertSenditConfigOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpsertSenditConfigsInput!]';
            };
        };
...
/**
 * A manager for the senditConfig model with all the available operations for reading and writing to it.*/
export declare const SenditConfigManager: {
