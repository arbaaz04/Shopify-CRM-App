...
import { Query, Select, DeepFilterNever, IDsList, PromiseOrLiveIterator, CustomCity, AvailableCustomCitySelection, CustomCitySort, CustomCityFilter, CreateCustomCityInput, UpdateCustomCityInput, Scalars, UpsertCustomCityInput } from "../types.js";
/**
...
*/
export type SelectedCustomCityOrDefault<Options extends Selectable<AvailableCustomCitySelection>> = DeepFilterNever<Select<CustomCity, DefaultSelection<AvailableCustomCitySelection, Options, typeof DefaultCustomCitySelection>>>;
/**
 ...
 * ```
 */
export type CustomCityRecord<Selection extends AvailableCustomCitySelection | undefined = typeof DefaultCustomCitySelection> = DeepFilterNever<GadgetRecord<SelectedCustomCityOrDefault<{
    select: Selection;
}>>>;
export declare const DefaultCustomCitySelection: {
...
declare const modelApiIdentifier: "customCity";
declare const pluralModelApiIdentifier: "customCities";
 ...
 **/
export type CreateCustomCityResult<Options extends CreateCustomCityOptions> = SelectedCustomCityOrDefault<Options> extends void ? void : GadgetRecord<SelectedCustomCityOrDefault<Options>>;
/**
 ...
 * Is a GadgetRecord of the model's type.
 **/
export type UpdateCustomCityResult<Options extends UpdateCustomCityOptions> = SelectedCustomCityOrDefault<Options> extends void ? void : GadgetRecord<SelectedCustomCityOrDefault<Options>>;
/**
 ...
 * This is the flattened style of inputs, suitable for general use, and should be preferred.
 **/
export type UpsertCustomCityVariables = Omit<UpsertCustomCityInput, "on"> & {
    on?: ((Scalars['String'] | null))[];
};
/**
 ...
 *
 **/
export type UpsertCustomCityResult<Options extends UpsertCustomCityOptions> = SelectedCustomCityOrDefault<Options> extends void ? void : GadgetRecord<SelectedCustomCityOrDefault<Options>>;
/**
...
export type CustomCityManager = {
    ...
    create: {
        ...
        * * const customCityRecord = await api.customCity.create({
          ...
          * });
        **/
        <Options extends CreateCustomCityOptions>(variables: CreateCustomCityVariables, options?: LimitToKnownKeys<Options, CreateCustomCityOptions>): Promise<CreateCustomCityResult<Options>>;
        /**
         * Executes the create action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        ...
        * * const customCityRecord = await api.customCity.create({
          ...
          * });
        **/
        <Options extends CreateCustomCityOptions>(variables: FullyQualifiedCreateCustomCityVariables, options?: LimitToKnownKeys<Options, CreateCustomCityOptions>): Promise<CreateCustomCityResult<Options>>;
        type: 'action';
        ...
        variables: {
            customCity: {
                required: false;
                type: 'CreateCustomCityInput';
            };
        };
        variablesType: (((FullyQualifiedCreateCustomCityVariables | CreateCustomCityVariables)) | undefined);
    ...
    bulkCreate: {
        /**
          ...
          */
        <Options extends CreateCustomCityOptions>(inputs: (FullyQualifiedCreateCustomCityVariables | CreateCustomCityVariables)[], options?: LimitToKnownKeys<Options, CreateCustomCityOptions>): Promise<CreateCustomCityResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkCreateCustomCitiesInput!]';
            };
        };
    ...
    update: {
        ...
        * * const customCityRecord = await api.customCity.update("1", {
          ...
          * });
        **/
        <Options extends UpdateCustomCityOptions>(id: string, variables: UpdateCustomCityVariables, options?: LimitToKnownKeys<Options, UpdateCustomCityOptions>): Promise<UpdateCustomCityResult<Options>>;
        /**
         * Executes the update actionon one record specified by `id`.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const customCityRecord = await api.customCity.update("1", {
          ...
          * });
        **/
        <Options extends UpdateCustomCityOptions>(id: string, variables: FullyQualifiedUpdateCustomCityVariables, options?: LimitToKnownKeys<Options, UpdateCustomCityOptions>): Promise<UpdateCustomCityResult<Options>>;
        type: 'action';
    ...
    bulkUpdate: {
        /**
          ...
          */
        <Options extends UpdateCustomCityOptions>(inputs: (FullyQualifiedUpdateCustomCityVariables | UpdateCustomCityVariables & {
            id: string;
        })[], options?: LimitToKnownKeys<Options, UpdateCustomCityOptions>): Promise<UpdateCustomCityResult<Options>[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpdateCustomCitiesInput!]';
            };
        };
        variablesType: (FullyQualifiedUpdateCustomCityVariables | UpdateCustomCityVariables & {
            id: string;
        })[];
        paramOnlyVariables: [];
        selectionType: AvailableCustomCitySelection;
    ...
    delete: {
        ...
        **/
        <Options extends DeleteCustomCityOptions>(id: string, options?: LimitToKnownKeys<Options, DeleteCustomCityOptions>): Promise<DeleteCustomCityResult<Options>>;
        type: 'action';
    ...
    bulkDelete: {
        /**
          ...
          */
        <Options extends DeleteCustomCityOptions>(ids: string[], options?: LimitToKnownKeys<Options, DeleteCustomCityOptions>): Promise<DeleteCustomCityResult<Options>[]>;
        type: 'action';
    ...
    upsert: {
        ...
        * * const result = await api.customCity.upsert({
          ...
          * });
        **/
        <Options extends UpsertCustomCityOptions>(variables: UpsertCustomCityVariables, options?: LimitToKnownKeys<Options, UpsertCustomCityOptions>): Promise<UpsertCustomCityResult<Options>>;
        /**
         * Executes the upsert action.Accepts the parameters for the action via the `variables` argument.Runs the action and returns a Promise for the updated record.
        *
        * This is the fully qualified, nested api identifier style overload that should be used when there's an ambiguity between an action param and a model field.
        ...
        * * const result = await api.customCity.upsert({
          ...
          * });
        **/
        <Options extends UpsertCustomCityOptions>(variables: FullyQualifiedUpsertCustomCityVariables, options?: LimitToKnownKeys<Options, UpsertCustomCityOptions>): Promise<UpsertCustomCityResult<Options>>;
        type: 'action';
        ...
        variables: {
            ...
            customCity: {
                required: false;
                type: 'UpsertCustomCityInput';
            };
        };
        variablesType: (((FullyQualifiedUpsertCustomCityVariables | UpsertCustomCityVariables)) | undefined);
        hasAmbiguousIdentifier: false;
        paramOnlyVariables: ['on'];
        hasReturnType: {
            '... on CreateCustomCityResult': {
                hasReturnType: false;
            };
            '... on UpdateCustomCityResult': {
                hasReturnType: false;
            };
        };
        acceptsModelInput: true;
    ...
    bulkUpsert: {
        /**
          ...
          */
        <Options extends UpsertCustomCityOptions>(inputs: (FullyQualifiedUpsertCustomCityVariables | UpsertCustomCityVariables)[], options?: LimitToKnownKeys<Options, UpsertCustomCityOptions>): Promise<any[]>;
        type: 'action';
        ...
        variables: {
            inputs: {
                required: true;
                type: '[BulkUpsertCustomCitiesInput!]';
            };
        };
...
/**
 * A manager for the customCity model with all the available operations for reading and writing to it.*/
export declare const CustomCityManager: {
