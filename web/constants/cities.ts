...
// Moroccan cities list - ADD ALL CITIES FROM INDEX.tsx HERE
...
// Speedaf cities list - ADD ALL SPEEDAF CITIES FROM INDEX.tsx HERE
export const SPEEDAF_CITIES = [
